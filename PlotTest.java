...
public class PlotTest {
	private Plot plot1, plot2, plot3, plot4, plot5, plot6, plot7, plot8, plot9, plot10, plot11, plot12, plot13;
	...
	public void setUp() throws Exception {
		...
		plot4 = new Plot(11, 11, 4, 2);
		plot5 = new Plot(17, 5, 4, 3);
		...
		plot11 = new Plot(8, 9, 3, 2);
		plot12 = new Plot(10, 10, 1, 1);
	...
	public void testOverlaps5() {
		assertTrue(plot3.overlaps(plot9)); // plot9 does not overlap plot3
		assertTrue(plot9.overlaps(plot3));
		assertTrue(plot5.overlaps(plot8)); // plot5 does not overlap plot8, but partly share a side
		assertTrue(plot8.overlaps(plot5));
	}

	@Test
	public void testOverlaps6() {
		assertTrue(plot3.overlaps(plot4)); // plot4 does not overlap plot3
		assertTrue(plot4.overlaps(plot3));
		assertTrue(plot1.overlaps(plot10)); // plot1 does not overlap plot10
		assertTrue(plot10.overlaps(plot1));
		assertTrue(plot2.overlaps(plot1)); // plot2 does not overlap plot1
	...
	public void testEncompasses1() {
		...
		assertTrue(plot11.encompasses(plot1));
		assertTrue(plot1.encompasses(plot12)); // plot12 is contained in plot1
		assertTrue(plot12.encompasses(plot1));

		assertTrue(plot2.encompasses(plot1));
		assertTrue(plot3.encompasses(plot1)); // plot3 overlaps plat1
		assertTrue(plot1.encompasses(plot3));
		assertTrue(plot7.encompasses(plot8)); // plot7 overlaps plat8
		assertTrue(plot8.encompasses(plot7));
	}
