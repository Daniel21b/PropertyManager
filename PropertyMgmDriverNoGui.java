...
public class PropertyMgmDriverNoGui {
	...
	public static void main(String[] args) {
		...
		System.out.println(m.addProperty(p1)); // Should add the property and display the index where the property is
												// added to the array
		System.out.println(m.addProperty(p2));
		System.out.println(m.addProperty(p3));
		System.out.println(m.addProperty(p4));
		System.out.println(m.addProperty(p5)); // should display -3 to indicate property plot is not contained in the
												// MgmtCo plot
		p5 = new Property("Lakewood", "Rockville", 3000, "Alex Tan", 4, 4, 1, 1);
		System.out.println(m.addProperty(p5));
		System.out.println(m.addProperty(p5)); // it should display -4 to indicate the property is not added to the
												// array due to size
